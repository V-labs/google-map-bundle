...
class EnumAddressComponentTyp
{
    ...
    CONST TABLE_2 = [
        ...
        'continent', 'country', 'establishment', 'finance', 'floor', 'food', 'general_contractor', 'geocode',
        'health', 'intersection', 'locality', 'natural_feature', 'neighborhood', 'place_of_worship', 'plus_code',
        'point_of_interest', 'political', 'post_box', 'postal_code', 'postal_code_prefix', 'postal_code_suffix',
    ...
    {
        return array_unique(array_merge(self::TABLE_1, self::TABLE_2));
    }
     ...
     * @return bool
     */
    public static function isValid(?string $value = null, bool $strict = true): bool
    {
        if(is_null($value) && !$strict) return true;
